...
/***
 * Given a stream of numbers write a program that computes sum of pair of
 * numbers. There should be two methods store and IsNumberPresent. The store
 * should store the numbers and IsNumberPresent should check if the number is
 * present in the computed sums.
 * 
 * @author ujjsingh
 *
 */
